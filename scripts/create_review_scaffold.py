...
![图示名称](images/moduleXX_slideYY_short_name.png)

- 来源：待填写。
- 图片路径：images/moduleXX_slideYY_short_name.png
- 对应知识点：待填写。
- 图示作用：待填写。
- 如何读图：待填写。
- 考试提示：待填写。

> 若当前环境无法提取或截图该图，应保留：图示待补、来源文件、页码/幻灯片、无法提取原因和读图说明。
...
| 内容 | 来源文件 | 页码/幻灯片 | 图片路径 | 复核状态 | 备注 |
|---|---|---|---|---|---|
| 待填写 | 待填写 | 待填写 | images/moduleXX_slideYY_short_name.png / 无 | 待回读 | 待填写 |
"""
...
| 模块 | 来源文件 | 页码/幻灯片范围 | 核心概念 | 重要图示 | 图片路径 | 提取状态 | 典型例子 | 考试角度 | 复核状态 |
|---|---|---|---|---|---|---|---|---|---|
"""
    for module in modules:
        source_map += f"| {module} | 待填写 | 待填写 | 待填写 | 待填写 | images/moduleXX_slideYY_short_name.png / 无 | 待提取 | 待填写 | 待填写 | 待回读 |\n"
